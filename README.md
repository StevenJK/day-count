...
→ **[stevenjk.github.io/day-count](https://stevenjk.github.io/day-count/)**
...
[Sonic Moments](https://github.com/StevenJK/sonic-feels): **the app makes no
...
The live version is GitHub Pages from `main`, served from the repo root. Fork
it, turn Pages on, and it's yours.
